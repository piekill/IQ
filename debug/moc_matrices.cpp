...
**
** Created: Sat Jan 16 22:10:32 2010
...
static const char qt_meta_stringdata_Matrices[] = {
    "Matrices\0"
};

const QMetaObject Matrices::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Matrices,
      qt_meta_data_Matrices, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Matrices::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Matrices))
        return static_cast<void*>(const_cast< Matrices*>(this));
